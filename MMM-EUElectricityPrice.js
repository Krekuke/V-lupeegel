...
Module.register("MMM-EUElectricityPrice", {
	...
	defaults: {
		dataSource: 'EE', //string, valid sources https://data.nordpoolgroup.com/auction/day-ahead/prices?deliveryDate=latest&currency=EUR&aggregation=Hourly&deliveryAreas=EE,LT,LV,AT,BE,FR,GER,NL,PL,DK1,DK2,FI,NO1,NO2,NO3,NO4,NO5,SE1,SE2,SE3,SE4
		currency: 'EUR', // NOK, SEK, DKK, PLN, EUR
		centName: 'eur', //e.g "øre" or "cents"
